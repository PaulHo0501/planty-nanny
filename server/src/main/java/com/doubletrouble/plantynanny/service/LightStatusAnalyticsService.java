...
public class LightStatusAnalyticsService {
    ...
    public int getTodayTotalOnHours() {
        ...
        LightStatus stateBeforeToday = repository.findTopByCreatedAtBeforeOrderByCreatedAtDesc(startOfDay);
        boolean wasOnAtMidnight = (stateBeforeToday != null && stateBeforeToday.getLightStatus() == LightState.ON);
